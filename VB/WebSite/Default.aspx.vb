...
Partial Public Class _Default
	...
	Protected Sub ASPxGridView1_CustomFilterExpressionDisplayText(ByVal sender As Object, ByVal e As DevExpress.Web.CustomFilterExpressionDisplayTextEventArgs)
